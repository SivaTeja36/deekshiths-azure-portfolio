  ...
  return (
    <section className="min-h-screen portfolio-gradient flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-dark-orange rounded-full mix-blend-multiply filter blur-xl opacity-20 floating-animation"></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-bright-orange rounded-full mix-blend-multiply filter blur-xl opacity-20 floating-animation" style={{ animationDelay: '-3s' }}></div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-12">
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="border-2 border-bright-orange text-bright-orange bg-transparent hover:bg-bright-orange hover:text-black hover:scale-105 transition-all duration-300 font-semibold"
              >
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start text-white/70">
              <div className="flex items-center gap-2">
                <span className="w-2 h-2 bg-bright-orange rounded-full animate-pulse-ring"></span>
                <span>8050284179</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-2 h-2 bg-dark-orange rounded-full animate-pulse-ring"></span>
          ...
          <div className="flex justify-center lg:justify-end fade-in-up" style={{ animationDelay: '0.3s' }}>
            <div className="bordered-image relative">
              <div className="w-80 h-80 lg:w-96 lg:h-96 bg-gradient-to-br from-dark-orange/20 to-bright-orange/20 rounded-2xl flex items-center justify-center backdrop-blur-sm">
              ...
              <div className="absolute -top-4 -right-4 w-8 h-8 bg-dark-orange rounded-full animate-pulse"></div>
              <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-bright-orange rounded-full animate-pulse" style={{ animationDelay: '0.5s' }}></div>
